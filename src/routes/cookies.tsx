...
export const Route = createFileRoute("/cookies")({
  head: () => ({
    meta: [
      { title: "Cookie Policy — Zentriq" },
      { name: "description", content: "How Zentriq uses cookies and similar technologies." },
      { property: "og:title", content: "Cookie Policy — Zentriq" },
      { property: "og:description", content: "How Zentriq uses cookies and similar technologies." },
    ],
  }),
  ...
  return (
    <MarketingShell>
      <LegalLayout title="Cookie Policy" updated="May 20, 2026">
        <p>This Cookie Policy explains how Zentriq uses cookies and similar technologies when you visit our website or use our product. We aim to keep this short, clear, and free of legalese.</p>
        ...
        <p>Essential cookies are required for Zentriq to function and cannot be disabled. For non-essential cookies, you can opt out at any time from your account settings.</p>

        <h2>5. Managing cookies in your browser</h2>
        <p>Most browsers let you view, manage, or delete cookies. Refer to your browser's documentation (Chrome, Safari, Firefox, Edge) for instructions. Note that disabling essential cookies may prevent parts of Zentriq from working correctly.</p>
        ...
        <h2>8. Contact</h2>
        <p>Questions about cookies? Email us at <a href="mailto:privacy@zentriq.com">privacy@zentriq.com</a>.</p>
      </LegalLayout>
    </MarketingShell>
  );
}